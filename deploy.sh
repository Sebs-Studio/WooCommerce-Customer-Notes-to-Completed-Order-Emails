# main config
PLUGINSLUG="woocommerce-customer-notes-to-completed-order-emails" # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="woocommerce-customer-notes-to-completed-order-emails.php" # this should be the name of your main php file in the wordpress plugin
